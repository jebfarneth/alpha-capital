...
SESSION="${SESSION:-i12pit_0940_strict}"
SCHEMA="${SCHEMA:-scratch_i12_pit_m1_0940_strict_20260618}"
...
SHARDS=(
  "may01_07:2026-05-01:2026-05-07:artifacts/stage0/i12_pit_0940_strict_may01_07.json"
  "may08_14:2026-05-08:2026-05-14:artifacts/stage0/i12_pit_0940_strict_may08_14.json"
  "may15_21:2026-05-15:2026-05-21:artifacts/stage0/i12_pit_0940_strict_may15_21.json"
  "may22_29:2026-05-22:2026-05-29:artifacts/stage0/i12_pit_0940_strict_may22_29.json"
  "jun01_05:2026-06-01:2026-06-05:artifacts/stage0/i12_pit_0940_strict_jun01_05.json"
)
...
print_valid_selectors() {
  echo "Valid strict shard selectors:" >&2
  for shard in "${SHARDS[@]}"; do
    IFS=":" read -r name _start_date _end_date _progress_artifact <<<"${shard}"
    echo "  ONLY_SHARD=${name} or ONLY_WINDOW=strict_${name}" >&2
  done
}
...
validate_replacement_scope() {
  ...
  if [[ "${REPLACE_RUNNING}" == "1" && "${selector_count}" -ne 1 ]]; then
    ...
    echo "Example: REPLACE_RUNNING=1 ONLY_WINDOW=strict_may15_21 $0" >&2
    exit 1
  fi
}
