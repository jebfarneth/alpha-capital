...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("base_risk_budget_pct", sa.Float(), nullable=True),
        sa.Column("risk_budget_pct", sa.Float(), nullable=True),
        sa.Column("risk_multiplier_product", sa.Float(), nullable=True),
        sa.Column("risk_sized_cap", sa.Float(), nullable=True),
        sa.Column("unstopped_heat_pct", sa.Float(), nullable=True),
        sa.Column("expected_round_trip_cost", sa.Float(), nullable=True),
        sa.Column("cost_to_edge_ratio", sa.Float(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("realized_entry_price", sa.Float(), nullable=True),
        sa.Column("execution_capture_gap", sa.Float(), nullable=True),
